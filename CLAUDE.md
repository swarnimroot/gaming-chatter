...
Latest shipped: **Phase 3c.24 (2026-05-20)**. Corpus: 1597 items / 1412 Haiku-enriched + embedded / 184 games / 247 per-ISO-week clusters / 4 synthesized `weekly_reports` rows (W17–W20). For phase-by-phase history and rationale, see `docs/SESSION_LOG.md`, `docs/DECISIONS.md`, and `CHANGELOG.md`.
